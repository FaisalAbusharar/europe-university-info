...
<>
  ...
  <br></br>
  <span style={gradientStyleRed} id="gradientSubSub" className="text-xl font-semibold mt-4 mb-1">Field-Specific Trends</span>
  <br></br>
  ...
  <span style={gradientStyleBlue} id="gradientSubSub" className="text-xl font-semibold mt-4 mb-1">Living Costs in Finland</span>
  <br></br>
  ...
  <br></br>
  <span style={gradientStyleBrownOrange} id="gradientSubSub" className="text-xl font-semibold mt-4 mb-1">Scholarship Opportunities</span>
  <br></br>
  ...
  <br></br>
  <span id="gradientSubSub" style={gradientStyleYellow} className="text-xl font-semibold mt-4 mb-1">Average Annual Cost of Study</span>
  <br></br>
