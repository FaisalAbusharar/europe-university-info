...
const Finland = () => {
    const CountryInformation = {
        ...
        whyChooseCountry: [
            { title: <>WHY <span id="gradientSub">FINLAND?</span></>, description: whyChooseFinland }
          ],
